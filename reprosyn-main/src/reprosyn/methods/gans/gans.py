...
from generator import PipelineBase

sys.path.insert(1, 'reprosyn-main/src/reprosyn/methods/gans/')
...
class PATEGAN(PipelineBase):
    ...
    def generate(self, refit=False):
        ...
        if (not self.gen) or refit:
            ...
            self.target_results = self.gen.fit(self.dataset.data, self.targets.data)
